import numpy as np
from Domain_contact import calculate_Domain
...
def con_ran(cell_id, type, chr_name, max_length, cell_dict):
    ...
    file_path = "../Data_filter/Collombet/%s/cell_%s_%s.txt" % (type, str(cell_id), chr_name)
...
def main():
    ...
    out_path = './Collombet_features/bosicp/bosicp.npy'
